                            ...
                            <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
                                <a href="#!">
                                    <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy"
                                        src="{{ $recipe->getImage() }}" alt="Nutrition">
                                </a>
                                <figcaption>
                            ...
                            <div class="card-body border bg-white p-4">
                                <div class="entry-header mb-3">
                                    <ul class="entry-meta list-unstyled d-flex mb-2">
                                        <li>
                                            <a class="link-primary text-decoration-none" href="#!">{{ $recipe->category
                                                }}</a>
                                        </li>
                                    </ul>
                                    <h2 class="card-title entry-title h4 mb-0">
                                        <a class="link-dark text-decoration-none" href="{{ $recipe->getLink() }}">{{
                                            $recipe->title }}</a>
                                    </h2>
                                    ...
                                    <li>
                                        <a class="fs-7 link-secondary text-decoration-none d-flex align-items-center"
                                            ...
                                            <span class="ms-2 fs-7">{{
                                                app('CustomHelper')->dateToReadable($recipe->publish_date) }}</span>
                                        </a>
                                    </li>
                                    <li>
