<div class="container">
    @include('resources/views/pages/prototype/users/portifilo/portfolio.blade.php')

    <link rel="stylesheet" href="https://unpkg.com/bootstrap@5.3.3/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://unpkg.com/bs-brain@2.0.4/components/blogs/blog-3/assets/css/blog-3.css">

    <!-- resources/views/pages/prototype/users/portifilo/portfolio.blade.php -->
<div>
    @livewire('chef-portfolio', ['chefId' => $chefId])
</div>
                    ...
                    <article>
                        <div class="card border-0">
                            <figure class="card-img-top m-0 overflow-hidden bsb-overlay-hover">
                                <a href="#!">
                                    <img class="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="{{ $recipe->getImage() }}" alt="Nutrition">
                                </a>
                                <figcaption>
                            ...
                            <div class="card-body border bg-white p-4">
                                <div class="entry-header mb-3">
                                    <ul class="entry-meta list-unstyled d-flex mb-2">
                                        <li>
                                            <a class="link-primary text-decoration-none" href="#!">{{ $recipe->category }}</a>
                                        </li>
                                    </ul>
                                ...
                                <ul class="entry-meta list-unstyled d-flex align-items-center m-0">
                                    <li>
                                        <a class="fs-7 link-secondary text-decoration-none d-flex align-items-center" href="#!">
                                            ...
                                            <span class="ms-2 fs-7">{{ app('CustomHelper')->dateToReadable($recipe->publish_date) }}</span>
                                        </a>
                                    </li>
                                    <li>
